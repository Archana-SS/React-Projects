...
function App() {
  ...
  return (
    <div className='flex flex-col items-center justify-center py-8'>
      ...
      '>
        {running ? <button className='border rounded-lg py-1 px-3.5' onClick={()=>{setRunning(false)}}>Stop</button> : (<button className='border rounded-lg py-1 px-3' onClick={()=>{setRunning(true)}}>Start</button>)}
